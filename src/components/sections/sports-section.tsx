...
const sportsData = [
  {
    title: 'Fútbol',
    description: 'El fútbol es el rey de los deportes en España, con una liga de renombre mundial (LaLiga) y equipos icónicos como el Real Madrid y el FC Barcelona. La selección nacional también ha logrado un gran éxito internacional.',
  ...
  {
    title: 'Tenis',
    description: 'España ha producido algunas de las mayores leyendas del tenis mundial. Rafael Nadal es un icono global y ha inspirado a generaciones de tenistas españoles. El país alberga numerosos torneos de prestigio.',
  ...
  {
    title: 'Baloncesto',
    description: 'El baloncesto goza de gran popularidad, con la Liga ACB considerada una de las mejores de Europa. La selección española de baloncesto ha ganado múltiples campeonatos mundiales y europeos.',
  ...
  {
    title: 'Ciclismo',
    description: 'El ciclismo tiene una rica historia en España, siendo la Vuelta a España una de las tres Grandes Vueltas. El país cuenta con desafiantes terrenos montañosos que atraen a ciclistas de todo el mundo.',
